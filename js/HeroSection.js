...
function renderHeroSection() {
    ...
    if (myComponentContainer) {
        ...
        />
        <div class="w-full md:w-max absolute top-[50%] left-[50%] transform -translate-x-[50%] -translate-y-[50%] bg-primaryRed/10 p-[20px] rounded-[5px]">
          <h1
            style={{
              lineHeight: "1.5",
            }}
            class="text-center text-xl lg:text-4xl font-[800]"
          >
        ...
        <div class="absolute bottom-[70px] right-[20px] transform translate-y-[100%]">
          <div class="w-[350px] bg-primaryBlue/75 text-white text-[14px] lg:text-xl font-bold relative p-[20px] rounded-[10px]">
          <div class="triangle" />
        <p>
